...
<nav class="bg-slate-900 border-gray-200 ">
  ...
  <a href="https://flowbite.com/" class="flex items-center space-x-3 rtl:space-x-reverse">
      ...
      <span class="self-center text-lg font-semibold whitespace-nowrap dark:text-white">Pato League</span>
  </a>
...
<div v-if="isDrawerOpen" class="fixed inset-0 z-40 flex">
    ...
    <div class="relative drawer-enter-active, drawer-leave-active flex flex-col w-64 h-full bg-slate-800 ">
        ...
        <div class="">
          ...
          <div class="pl-4">
            <h4 class="font-[Inter] font-semibold text-white">Olá, cayo!</h4>
          </div>
          <div class="p-4">
